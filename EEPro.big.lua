...
main.sel = 1
main.items = {
    { title = "Analysis", info = "Not yet done\nStay tuned !", action = pushanalysis },
    { title = "FormulaPro", info = "More than 700\nformulas, equations\nartranged in categories", action = pushformulapro },
    { title = "Reference", info = "General Physics\nknowlegde", action = pushreference }
}
...
function main:paint(gc)
    gc:setFont("sansserif", "b", 12)
    gc:drawString("EEPro for the TI-Nspire", 5, 2, "top")
    gc:drawString("v1.1c", .85*kXSize, 2, "top")
    
    gc:setFont("sansserif", "r", 10)
    gc:drawString("TI-Planet.org  -  Inspired-Lua.org", 5, kYSize-22, "top")
...
function createAbout()
    aboutWindow = Dialog("About EEPro :", 50, 20, kXSize > 330 and 340 or 280, 180)
    local aboutstr = [[EEPro v1.1c
------------------------------
...
http://tiplanet.org  and  www.inspired-lua.org]]
    ...
    function aboutButton:action()
        ...
        on.help = function() createAbout() end
    end
...
function errorPopup(gc)
    ...
    local textMessage = [[EEPro has encountered an error
-----------------------------
